...
namespace Whisperer
{
	...
	public class UXManager : MonoBehaviour
	{
		...
		[SerializeField] RigHandsControl _rigHandsControl;
		[SerializeField] List<UXTrackedDisplay> _displays = new List<UXTrackedDisplay>();

		bool _disableMenuToggles;
		...
		IEnumerator CloseDisplayNextFrame(UXTrackedDisplay d)
		{
