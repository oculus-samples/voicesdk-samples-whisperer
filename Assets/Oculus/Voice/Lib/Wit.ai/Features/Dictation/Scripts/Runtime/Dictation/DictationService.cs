...
{
    public abstract class DictationService : MonoBehaviour, IDictationService, IAudioEventProvider,
        ITranscriptionEventProvider
    {
        [Tooltip("Events that will fire before, during and after an activation")] [SerializeField]
        public DictationEvents dictationEvents = new();
