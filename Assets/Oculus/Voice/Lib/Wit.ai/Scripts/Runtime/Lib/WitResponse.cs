...
namespace Facebook.WitAi.Lib
{
    ...
    public class WitResponseNode
    {
        ...
        public virtual string[] AsStringArray
        {
            get
            {
                ...
                if (null != jsonArray)
                {
                    ...
                    for (var i = 0; i < array.Length; i++) array[i] = jsonArray[i].Value;
                }
        ...
        public virtual WitEntityData AsWitEntity => new(this);
        public virtual WitEntityFloatData AsWitFloatEntity => new(this);
        public virtual WitEntityIntData AsWitIntEntity => new(this);

        public virtual WitIntentData AsWitIntent => new(this);
        ...
        {
            var stack = new Stack<WitResponseNode>();
            ...
            if (QuoteMode) throw new JSONParseException("JSON Parse: Quotation marks seems to be messed up.");
        ...
        {
#if USE_FileIO
            Directory.CreateDirectory(new FileInfo(aFileName).Directory
                .FullName);
    ...
    {
        private readonly List<WitResponseNode> m_List = new();
        ...
        {
            get => new WitResponseLazyCreator(this);
    ...
    {
        private readonly Dictionary<string, WitResponseNode> m_Dict = new();
    ...
    internal class WitResponseLazyCreator : WitResponseNode
    {
        ...
        public override WitResponseNode this[string aKey]
        {
            get => new WitResponseLazyCreator(this, aKey);
            set
            {
                var tmp = new WitResponseClass
                {
        ...
        public override int AsInt
        {
            get
            {
                var tmp = new WitResponseData(0);
                Set(tmp);
                return 0;
            }
            set
            {
                var tmp = new WitResponseData(value);
                Set(tmp);
            }
        }
        ...
        public override float AsFloat
        {
            get
            {
                var tmp = new WitResponseData(0.0f);
                Set(tmp);
                return 0.0f;
            }
            set
        ...
        public override double AsDouble
        {
            get
            {
                var tmp = new WitResponseData(0.0);
                Set(tmp);
                return 0.0;
            }
            set
        ...
        public override bool AsBool
        {
            get
            {
                var tmp = new WitResponseData(false);
                Set(tmp);
                return false;
            }
            set
