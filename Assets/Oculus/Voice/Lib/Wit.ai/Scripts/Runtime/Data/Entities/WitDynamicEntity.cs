...
namespace Facebook.WitAi.Data.Entities
{
    ...
    public class WitDynamicEntity : IDynamicEntitiesProvider
    {
        ...
        public List<WitEntityKeyword> keywords = new();
        ...
        {
            this.entity = entity;
            foreach (var keyword in keywords) this.keywords.Add(new WitEntityKeyword(keyword));
        }
        ...
        public WitResponseArray AsJson
        {
            get
            {
                ...
                foreach (var keyword in keywords) synonymArray.Add(keyword.AsJson);
