...
namespace Facebook.WitAi
{
    ...
    public class WitRequest
    {
        ...
        public static string GetUserAgent(WitConfiguration configuration)
        {
            ...
            // Return full string
            return $"voice-sdk-45.0.0.4.140,wit-unity-{WIT_SDK_VERSION},{_operatingSystem},{_deviceModel},{configId},{_appIdentifier},{userEditor},{_unityVersion}{customUserAgents}";
        }
