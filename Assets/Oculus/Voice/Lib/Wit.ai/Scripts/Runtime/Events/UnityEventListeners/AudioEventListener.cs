...
namespace Facebook.WitAi.Events.UnityEventListeners
{
    ...
    {
        [SerializeField] private WitMicLevelChangedEvent onMicAudioLevelChanged = new();
        [SerializeField] private UnityEvent onMicStartedListening = new();
        [SerializeField] private UnityEvent onMicStoppedListening = new();
        ...
        private IAudioInputEvents AudioInputEvents
        {
            get
            {
                if (null == _events)
                {
                    ...
                    if (null != eventProvider) _events = eventProvider.AudioEvents;
                }
