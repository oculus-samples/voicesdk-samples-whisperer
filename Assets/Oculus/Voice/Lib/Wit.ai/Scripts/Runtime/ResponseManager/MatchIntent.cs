...
namespace Facebook.WitAi
{
    ...
    public class MatchIntent : ConduitActionAttribute
    {
        ...
        public MatchIntent(string intent, float minConfidence = DEFAULT_MIN_CONFIDENCE,
            float maxConfidence = DEFAULT_MAX_CONFIDENCE) : base(intent, minConfidence, maxConfidence)
        {
        }
    }
}
