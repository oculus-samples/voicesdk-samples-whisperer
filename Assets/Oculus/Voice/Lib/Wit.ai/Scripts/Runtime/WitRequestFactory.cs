...
namespace Facebook.WitAi
{
    public static class WitRequestFactory
    {
        ...
        {
            var entities = new WitResponseClass();
            ...
            {
                if (!string.IsNullOrEmpty(requestOptions.tag)) queryParams.Add(QueryParam("tag", requestOptions.tag));
        ...
        public static WitRequest MessageRequest(this WitConfiguration config, string query,
            WitRequestOptions requestOptions, IDynamicEntitiesProvider[] additionalDynamicEntities = null)
        {
            var queryParams = new List<WitRequest.QueryParam>
            {
                QueryParam("q", query)
            };
            ...
            var request = new WitRequest(config, path, queryParams.ToArray());
