...
namespace Facebook.WitAi
{
    public static class WitTexts
    {
        ...
        static WitTexts()
        {
            ...
            var textFilePath = $"witai_texts_{languageID}";
            ...
            SettingsServerTokenContent =
                new GUIContent(Texts.SettingsServerTokenLabel, Texts.SettingsServerTokenTooltip);
        ...
        public static string GetAppURL(string appId, WitAppEndpointType endpointType)
        {
            ...
            var url = WitUrl + Texts.WitAppsUrl;
            if (string.IsNullOrEmpty(appId)) return url;
            // Determine endpoint
            string endpoint;
            switch (endpointType)
            {
            ...
            if (string.IsNullOrEmpty(endpoint)) return url;
        ...
        {
            [Header("Shared Settings Texts")] public string LanguageID;
            ...
            [Header("Setup Settings Texts")] public string SetupTitleLabel;
            ...
            [Header("Understanding Viewer Texts")] public string UnderstandingViewerLabel;
            ...
            [Header("Configuration Texts")] public string ConfigurationHeaderLabel;
            ...
            [Header("Configuration Intent Texts")] public string ConfigurationIntentsTabLabel;
            ...
            [Header("Configuration Entity Texts")] public string ConfigurationEntitiesTabLabel;
            ...
            [Header("Configuration Trait Texts")] public string ConfigurationTraitsTabLabel;
