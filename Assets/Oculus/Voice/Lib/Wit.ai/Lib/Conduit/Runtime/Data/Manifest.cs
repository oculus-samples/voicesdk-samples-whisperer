    ...
    internal class Manifest
    {
        ...
        public bool ResolveActions()
        {
            ...
            foreach (var action in Actions)
            {
                ...
                if (!methodLookup.ContainsKey(action.Name))
                    methodLookup.Add(action.Name, new List<InvocationContext>());

                methodLookup[action.Name].Add(invocationContext);
            }

            foreach (var invocationContext in methodLookup.Values.Where(invocationContext =>
        ...
        {
            return methodLookup.ContainsKey(action);
        }
