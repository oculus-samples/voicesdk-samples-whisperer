...
namespace Oculus.Voice.Bindings.Android
{
    ...
    {
        private readonly WitRuntimeConfiguration configuration;
        ...
        public AndroidJavaObject ToJavaObject()
        {
            ...
            var witRuntimeConfig =
                new AndroidJavaObject(
                    "com.oculus.assistant.api.voicesdk.immersivevoicecommands.WitRuntimeConfiguration");
