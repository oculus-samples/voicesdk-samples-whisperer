...
public class ONSPAudioSource : MonoBehaviour
{
    ...
    [SerializeField] private bool useInvSqr;
    ...
    [SerializeField] private float near = 0.25f;
    ...
    [SerializeField] private float far = 250.0f;
    ...
    [SerializeField] private float volumetricRadius;
    ...
    [SerializeField] private float reverbSend;
    ...
    [SerializeField] private bool enableRfl;
    ...
    private void OnDrawGizmos()
    {
        ...
        if (RoomReflectionGizmoAS == null) RoomReflectionGizmoAS = this;
    ...
    private void OnDestroy()
    {
        ...
        if (RoomReflectionGizmoAS == this) RoomReflectionGizmoAS = null;
    }
